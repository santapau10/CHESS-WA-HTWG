...
trait BoardBuilder {
  ...
  def getSetupBoard(): List[Pieces]
}



abstract class Board(size: Int) extends BoardBuilder {
  val h2Line = "__"
  val hLine = "_"
  val vLine = "|"
  val space = " "
  ...
  override def getSetupBoard(): List[Pieces] ={
    List.empty
  }

  override def movePieces(x1: Int, y1: Int, x2: Int, y2: Int, list: List[Pieces]): List[Pieces] = {
  ...
  override def checkFieldR(x: Int, y: Int, list: List[Pieces]): String = {
...
class Board_bigger_8(size: Int) extends Board(size: Int) {
  override def getSetupBoard(): List[Pieces] = {
    if(size % 2 == 0 && size > 8) {
      ...
      val i = size - 8
      val a = List(
        Pieces.addPiece(Chesspiece.ROOK, (h - 4, 0), Colors.WHITE),
        Pieces.addPiece(Chesspiece.KNIGHT, (h - 3, 0), Colors.WHITE),
        Pieces.addPiece(Chesspiece.BISHOP, (h - 2, 0), Colors.WHITE),
        Pieces.addPiece(Chesspiece.QUEEN, (h - 1, 0), Colors.WHITE),
        Pieces.addPiece(Chesspiece.KING, (h, 0), Colors.WHITE),
        Pieces.addPiece(Chesspiece.BISHOP, (h + 1, 0), Colors.WHITE),
        Pieces.addPiece(Chesspiece.KNIGHT, (h + 2, 0), Colors.WHITE),
        Pieces.addPiece(Chesspiece.ROOK, (h + 3, 0), Colors.WHITE),
        Pieces.addPiece(Chesspiece.PAWN, (h - 4, 1), Colors.WHITE),
        Pieces.addPiece(Chesspiece.PAWN, (h - 3, 1), Colors.WHITE),
        Pieces.addPiece(Chesspiece.PAWN, (h - 2, 1), Colors.WHITE),
        Pieces.addPiece(Chesspiece.PAWN, (h - 1, 1), Colors.WHITE),
        Pieces.addPiece(Chesspiece.PAWN, (h, 1), Colors.WHITE),
        Pieces.addPiece(Chesspiece.PAWN, (h + 1, 1), Colors.WHITE),
        Pieces.addPiece(Chesspiece.PAWN, (h + 2, 1), Colors.WHITE),
        Pieces.addPiece(Chesspiece.PAWN, (h + 3, 1), Colors.WHITE),

        Pieces.addPiece(Chesspiece.ROOK, (h - 4, size - 1), Colors.BLACK),
        Pieces.addPiece(Chesspiece.KNIGHT, (h - 3, size - 1), Colors.BLACK),
        Pieces.addPiece(Chesspiece.BISHOP, (h - 2, size - 1), Colors.BLACK),
        Pieces.addPiece(Chesspiece.QUEEN, (h - 1, size - 1), Colors.BLACK),
        Pieces.addPiece(Chesspiece.KING, (h, size - 1), Colors.BLACK),
        Pieces.addPiece(Chesspiece.BISHOP, (h + 1, size - 1), Colors.BLACK),
        Pieces.addPiece(Chesspiece.KNIGHT, (h + 2, size - 1), Colors.BLACK),
        Pieces.addPiece(Chesspiece.ROOK, (h + 3, size - 1), Colors.BLACK),
        Pieces.addPiece(Chesspiece.PAWN, (h - 4, size - 2), Colors.BLACK),
        Pieces.addPiece(Chesspiece.PAWN, (h - 3, size - 2), Colors.BLACK),
        Pieces.addPiece(Chesspiece.PAWN, (h - 2, size - 2), Colors.BLACK),
        Pieces.addPiece(Chesspiece.PAWN, (h - 1, size - 2), Colors.BLACK),
        Pieces.addPiece(Chesspiece.PAWN, (h, size - 2), Colors.BLACK),
        Pieces.addPiece(Chesspiece.PAWN, (h + 1, size - 2), Colors.BLACK),
        Pieces.addPiece(Chesspiece.PAWN, (h + 2, size - 2), Colors.BLACK),
        Pieces.addPiece(Chesspiece.PAWN, (h + 3, size - 2), Colors.BLACK)
      )
